...
namespace WF_M500_03_12
{
        ...
        public partial class ModbusClient
        {
            ...
            {
                if (debug) StoreLogData.Instance.Store("WF_M500_03_12 library initialized for Modbus-TCP, IPAddress: " + ipAddress + ", Port: " + port, System.DateTime.Now);
#if (!COMMERCIAL)
                Console.WriteLine("WF_M500_03_12 Client Library Version: " + Assembly.GetExecutingAssembly().GetName().Version.ToString());
            ...
            {
                if (debug) StoreLogData.Instance.Store("WF_M500_03_12 library initialized for Modbus-RTU, COM-Port: " + serialPort, System.DateTime.Now);
#if (!COMMERCIAL)
                Console.WriteLine("WF_M500_03_12 Client Library Version: " + Assembly.GetExecutingAssembly().GetName().Version.ToString());
                Console.WriteLine("Copyright (c) Stefan Rossmann Engineering Solutions");
                Console.WriteLine();
            ...
            public ModbusClient()
            {
                if (debug) StoreLogData.Instance.Store("WF_M500_03_12 library initialized for Modbus-TCP", System.DateTime.Now);
#if (!COMMERCIAL)
                Console.WriteLine("WF_M500_03_12 Client Library Version: " + Assembly.GetExecutingAssembly().GetName().Version.ToString());
                Console.WriteLine("Copyright (c) Stefan Rossmann Engineering Solutions");
                Console.WriteLine();
            ...
            public void Connect()
            {
                ...
                if (!udpFlag)
                {
                    ...
                    if (!success)
                    {
                        throw new WF_M500_03_12.Exceptions.ConnectionException("connection timed out");
                    }
            ...
            /// <summary>
            /// Converts two ModbusRegisters to Float - Example: WF_M500_03_12.ModbusClient.ConvertRegistersToFloat(modbusClient.ReadHoldingRegisters(19,2))
            /// </summary>
            ...
            /// <summary>
            /// Converts float to two ModbusRegisters - Example:  modbusClient.WriteMultipleRegisters(24, WF_M500_03_12.ModbusClient.ConvertFloatToTwoRegisters((float)1.22));
            /// </summary>
            ...
            public bool[] ReadDiscreteInputs(int startingAddress, int quantity)
            {
                ...
                if (serialport != null)
                    if (!serialport.IsOpen)
                    {
                        ...
                        throw new WF_M500_03_12.Exceptions.SerialPortNotOpenedException("serial port not opened");
                    }
                if (tcpClient == null & !udpFlag & serialport == null)
                {
                    ...
                    throw new WF_M500_03_12.Exceptions.ConnectionException("connection error");
                }
                ...
                if (data[7] == 0x82 & data[8] == 0x01)
                {
                    ...
                    throw new WF_M500_03_12.Exceptions.FunctionCodeNotSupportedException("Function code not supported by master");
                }
                if (data[7] == 0x82 & data[8] == 0x02)
                {
                    ...
                    throw new WF_M500_03_12.Exceptions.StartingAddressInvalidException("Starting address invalid or starting address + quantity invalid");
                }
                if (data[7] == 0x82 & data[8] == 0x03)
                {
                    if (debug) StoreLogData.Instance.Store("QuantityInvalidException Throwed", System.DateTime.Now);
                    throw new WF_M500_03_12.Exceptions.QuantityInvalidException("quantity invalid");
                }
                if (data[7] == 0x82 & data[8] == 0x04)
                {
                    if (debug) StoreLogData.Instance.Store("ModbusException Throwed", System.DateTime.Now);
                    throw new WF_M500_03_12.Exceptions.ModbusException("error reading");
                }
                if (serialport != null)
                {
                    ...
                    if ((crc[0] != data[data[8] + 9] | crc[1] != data[data[8] + 10]) & dataReceived)
                    {
                        ...
                        {
                            countRetries = 0;
                            throw new WF_M500_03_12.Exceptions.CRCCheckFailedException("Response CRC check failed");
                        }
                        else
                        {
                            countRetries++;
